...
class CheckoutScreenState extends State<CheckoutScreen> {
      ...
      body: guestCheckoutPermission || AuthHelper.isLoggedIn()
          ? GetBuilder<CheckoutController>(
              builder: (checkoutController) {
                ...
                bool hasDigitalItems = _hasDigitalItems();

                bool requiresUserFillableData = _requiresUserFillableData();
                print(
                  "=======================================================",
                );
                print(
                ...
                print(hasDigitalItems);
                print(requiresUserFillableData);
                print(
                  "=======================================================",
                );
                print(
                ...
                if (hasDigitalItems) {
                  checkoutController.setOrderType('take_away', notify: false);
                }
                        ...
                        placeOrderBody = PlaceOrderBodyModel(
                          ...
                          deliveryInstruction:
                              ...
                              ? AppConstants
                                    ...
                                    .selectedInstruction]
                              : '',
                          partialPayment: checkoutController.isPartialPay
                              ? 1
                              : 0,
        ...
        child: CustomButton(
          ...
          onPressed: checkoutController.acceptTerms
              ? () async {
                  ...
                  if (isGuestLogIn &&
                      checkoutController.orderType == 'take_away' &&
                      guestContactPersonNumberController.text.isNotEmpty) {
  ...
  bool _hasDigitalItems() {
    if (_cartList != null) {
      for (var cart in _cartList!) {
        if (cart?.item?.isDigital == 1) {
          return true;
        }
      }
    }
  ...
  bool _requiresUserFillableData() {
    if (_cartList != null) {
      for (var cart in _cartList!) {
        if (cart?.item?.isDigital == 1 && cart?.item?.isUserFillable == 1) {
          return true;
        }
      }
    }
