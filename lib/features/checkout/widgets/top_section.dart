...
class TopSection extends StatelessWidget {
  ...
  final bool hasDigitalItems;
  final bool requiresUserFillableData;
  final TextEditingController userFillableDataController;
  ...
  const TopSection({
    ...
    required this.hasDigitalItems,
    required this.requiresUserFillableData,
    required this.userFillableDataController,
  });
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // delivery option - hide for digital items
          !hasDigitalItems
              ? Container(
                  decoration: BoxDecoration(
                    color: Theme.of(context).cardColor,
          ...
          ///delivery section - Hidden for digital items
          !hasDigitalItems
              ? DeliverySection(
          ...
          SizedBox(
            height: !takeAway && !hasDigitalItems
                ? isDesktop
          ...
          ///delivery instruction - Hidden for digital items
          !takeAway && !hasDigitalItems
              ? isDesktop
          ...
          /// User Fillable Data Field - Only for digital items requiring user input
          requiresUserFillableData
              ? Container(
                  decoration: BoxDecoration(
                    color: Theme.of(context).cardColor,
                    boxShadow: [
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('required_information'.tr, style: robotoMedium),
                      const SizedBox(height: Dimensions.paddingSizeSmall),
                      TextField(
                        controller: userFillableDataController,
                        decoration: InputDecoration(
                          hintText: 'enter_required_details'.tr,
